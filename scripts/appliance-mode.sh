...
chmod +x "${PROJECT_DIR}/scripts/kiosk-launch.sh" "${PROJECT_DIR}/scripts/kiosk-xinit.sh" 2>/dev/null || true
...
echo "Smart Thermostat appliance mode enabled: desktop disabled, kiosk owns the display, profile/cache in RAM."
